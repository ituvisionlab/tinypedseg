...
data_root = './tinypedseg'  # Update with your data root
img_norm_cfg = dict(
...
log_level = 'INFO'
load_from = None
#work_dir = './work_dirs/deeplabv3_unet'
resume_from = None
workflow = [('train', 1)]
...
evaluation = dict(interval=100, metric=['mIoU','mDice'], pre_eval=True, save_best = 'mDice')
